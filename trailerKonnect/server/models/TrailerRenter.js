...
startDate: {type: Date, required: true, minLength: 1, maxLength:100},
endDate: {type: Date, required: true, minLength: 1, maxLength:100},
cost: {type: String, minLength: 1, maxLength: 10000, required: true, default: "daily/weekly rate goes here + deposit amount"},
totalCost: {type: String, minLength: 1, maxRentalLength: 10000, required: true, default: "total cost of rental goes here"},
