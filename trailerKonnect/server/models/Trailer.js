...
export const TrailerSchema = new Schema (
{
    ...
    description: {type: String, minLength:1, maxLength: 10000, default: "description goes here"},
    details: {type: String, minLength:1, maxLength: 10000, default: "details go here"},
    rules: {type: String, minLength:1, maxLength: 10000, default: "rules go here"},
    dailyRate: {type: String, minLength:1, maxLength: 10000, default: "daily rate goes here"},
    weeklyRate: { type: String, minLength: 1, maxLength: 10000, default: "daily rate goes here" },
    addons: {type: String, minLength:1, maxLength: 10000, default: "addons goes here"},
    deposit: {type: String, minLength:1, maxLength: 10000, default: "deposit goes here"},
